    ...
    *,
    ...
    if any(s.risk_classification == "prohibited" for s in systems):
        ...
        pdf.cell(
            0,
            6,
            "ALERT: Prohibited AI systems detected. Immediate action required (Art 5).",
            new_x="LMARGIN",
            new_y="NEXT",
        )
    ...
    if high_risk:
        ...
        pdf.cell(
            0,
            6,
            "No high-risk systems requiring FRIA.",
            new_x="LMARGIN",
            new_y="NEXT",
        )
    pdf.ln(6)
    ...
    for s in systems:
        ...
        pdf.cell(
            0,
            5,
            f"  {s.name} ({s.vendor or 'N/A'}): AI Annex={annex}, Obligations Documented={oblig}",
            new_x="LMARGIN",
            new_y="NEXT",
        )
    pdf.ln(6)
    ...
    pdf.cell(
        0,
        5,
        f"Generated by AgenticAudit | {ts} | Regulation (EU) 2024/1689 (AI Act)",
        new_x="LMARGIN",
        new_y="NEXT",
    )
