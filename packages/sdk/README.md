...
- **Claude Code** — zero-overhead deterministic hooks via [`agentaudit-hook`](https://pypi.org/project/agentaudit-hook/)
- **Cowork** — plugin with automatic hook registration
- **LangChain** — `pip install agentaudit[langchain]` for callback handler
